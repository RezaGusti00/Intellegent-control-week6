...
MODEL_PATH = r"C:\Users\rezag\Intellegent-control-week6\best.pt"
...
def detect_canny_edges_with_model(low_threshold=50, high_threshold=150):
    ...
    while True:
        ...
        if hasattr(predictions, "masks") and predictions.masks is not None:  # Model segmentasi
        ...
        elif hasattr(predictions, "boxes") and predictions.boxes is not None:  # Model deteksi objek
